...
const { createSubCompanyMiddleware,updateSubCompanyMiddleware,genAPIKeySubCompanyMiddleware,singlerecharge,checkBalance,rechargeStatus} = require('../middleware/validators/subCompanyValidator.middleware.js');
...
const validateSubCompanyAuthCheckBalance = require('../middleware/validateSubCompanyAuthCheckBalance.middleware.js');



//  routes to be used by sub-company
...
router.get('/check-balance',checkBalance,validateSubCompanyAuthCheckBalance, awaitHandlerFactory(subCompanyController.checkSubCompanyBalance));
