...
router.post('/activation',auth(1,2,3,4,5,6), accessManager({agent : { module: [2,1], permission: apiMethod.add }}), awaitHandlerFactory(bundlebundlebundleRechargeController.bundlesinglerecharge));
