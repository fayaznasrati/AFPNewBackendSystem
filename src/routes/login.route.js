...
router.get('/download-all-agent', getAllAgent, auth(role.Admin,role.SubAdmin,1,2,3,4,5), accessManager({subAdmin : { module: [1,1], permission: apiMethod.view } , agent: { module: [1,1], permission: apiMethod.view }}), awaitHandlerFactory(loginController.donloadAllAgent))
