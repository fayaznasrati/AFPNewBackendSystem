...
router.post('/contact/verify', checkNumber, auth(role.Admin,role.SubAdmin,1,2,3,4,5), accessManager({subAdmin : { module: [1,1], permission: apiMethod.add } , agent: { module: [1,1], permission: apiMethod.add }}), awaitHandlerFactory(agentController.checkContactNumber)) // child condition applyed
