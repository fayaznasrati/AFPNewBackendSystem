...
class rechargeModule {
  ...
  agentTopupReport = async (searchKeyValue, limit, offset) => {
    ...
    var sql = `SELECT /*+ MAX_EXECUTION_TIME(${process.env.SQL_QUERY_TIME_OUT}) */ ${this.tableName2}.username AS userId, ${this.tableName2}.full_name AS userName,${this.tableName2}.province_Name AS province,${this.tableName2}.region_name AS region,
