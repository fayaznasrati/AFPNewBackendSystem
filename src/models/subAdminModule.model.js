...
class subAdminModel {
  ...
  getAllModuleWithSubModules = async () => {
    const sql = `  SELECT  ${this.tableName1}.sub_admin_module_name AS ModuleName,
                                ${this.tableName1}.sub_admin_module_title AS ModuleTitle,
                                ${this.tableName2}.sub_admin_sub_module_name AS subModuleName,
                                ${this.tableName2}.sub_admin_sub_module_title AS subModuleTitle
  ...
  subAdminAssignRights = async (department_uuid) => {
    const sql = `SELECT ${this.tableName1}.sub_admin_module_name AS ModuleName, ${this.tableName1}.sub_admin_module_title AS ModuleTitle,
                        ...
                        FROM ${this.tableName1} LEFT JOIN ${this.tableName2} ON ${this.tableName1}.sub_admin_module_id = ${this.tableName2}.sub_admin_module_id
                                                LEFT JOIN ${this.tableName3} ON ${this.tableName1}.sub_admin_module_id = ${this.tableName3}.sub_admin_module_id
